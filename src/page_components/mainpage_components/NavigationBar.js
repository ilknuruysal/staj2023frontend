...
//               style={{ color: "#8a2be2", fontSize: "2.0rem" }}
//             />
//             <b>{this.props.cart.length}</b> products in the cart
//           </NavbarText>

//           <NavbarBrand style={{ color: "#8a2be2", fontSize: "3.0rem" }}>
//             <b>TECHNOLOGY STORE</b>
//           </NavbarBrand>
...
//                 <DropdownToggle nav caret style={{ textAlign: "right" }}>
//                   Options
//                 </DropdownToggle>

//                 <DropdownMenu right style={{ textAlign: "center" }}>
//                   <DropdownItem>
//                     Show My Cart <i className="pi pi-shopping-cart" />
//                   </DropdownItem>
